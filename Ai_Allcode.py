...
Original file is located at
    https://colab.research.google.com/drive/1U1CZZWAM1MRAE-qJhBm0uVwYCtnfMmDR
"""
...
chatbot_data3 = pd.read_csv('5차년도_2차.csv', encoding='cp949')
chatbot_data4 = pd.read_csv('most_common.csv', encoding='utf-8')
...
chatbot_data3.loc[(chatbot_data3['상황'] == "fear"), '상황'] = 0  #공포 => 0
chatbot_data3.loc[(chatbot_data3['상황'] == "surprise"), '상황'] = 1  #놀람 => 1
chatbot_data3.loc[(chatbot_data3['상황'] == "angry"), '상황'] = 2  #분노 => 2
chatbot_data3.loc[(chatbot_data3['상황'] == "sadness"), '상황'] = 3  #슬픔 => 3
chatbot_data3.loc[(chatbot_data3['상황'] == "neutral"), '상황'] = 4  #중립 => 4
chatbot_data3.loc[(chatbot_data3['상황'] == "happiness"), '상황'] = 5  #행복 => 5
chatbot_data3.loc[(chatbot_data3['상황'] == "disgust"), '상황'] = 6  #혐오 => 6

chatbot_data4.loc[(chatbot_data4['emotion'] == "Fear"), 'emotion'] = 0  #공포 => 0
chatbot_data4.loc[(chatbot_data4['emotion'] == "Surprise"), 'emotion'] = 1  #놀람 => 1
chatbot_data4.loc[(chatbot_data4['emotion'] == "Angry"), 'emotion'] = 2  #분노 => 2
chatbot_data4.loc[(chatbot_data4['emotion'] == "Sadness"), 'emotion'] = 3  #슬픔 => 3
chatbot_data4.loc[(chatbot_data4['emotion'] == "Neutral"), 'emotion'] = 4  #중립 => 4
chatbot_data4.loc[(chatbot_data4['emotion'] == "Happiness"), 'emotion'] = 5  #행복 => 5
chatbot_data4.loc[(chatbot_data4['emotion'] == "Disgust"), 'emotion'] = 6  #혐오 => 6
...
for q, label in zip(chatbot_data3['발화문'], chatbot_data3['상황'])  :
    data = []
    data.append(q)
    data.append(str(label))
...
for q, label in zip(chatbot_data4['speech'], chatbot_data4['emotion'])  :
    data = []
    data.append(q)
    data.append(str(label))
...
'''
dataset_train, dataset_valid = train_test_split(data_list, test_size=0.2, shuffle=True, random_state=42)
